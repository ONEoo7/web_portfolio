...
- concepts and guidelines: confluence
...
- requirements engineering: IBM Doors, Windchill RV&S, Codebeamer
...
- static code check: Klocwork, AbsInt
- code coverage: Bullseye, gcov/lcov
- build systems: make, cmake, svm, bitbake, waf, buildroot
- templating: jinja2
...
- AI tools: RAGFlow, OpenWebUI, AnythingLLM, Lemonade Server, Langfuse, LiteLLM Proxy Server, Qdrant, neo4j
- communication bus: CAN, LIN, Ethernet, SPI, D-BUS, RemoteNG